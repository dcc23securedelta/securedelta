...
public:
     ...
     */
    void create(const internal_file_name_t &fileName) {
    ...
    /**
     * @brief get the size of the memory region, with is also the size of the mapped file
     */
    auto size() const {
