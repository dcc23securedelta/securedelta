...
public:
    ...
    /**
     * @brief get the total time recorded by this timer
     */
    ...
    /**
     * @brief get the current time pointer of the timer
     */
...
public:
    ...
    static std::string Result() {
        ...
        auto restoreFromDeltaTime = RestoreDeltaTimer().to_string();
    ...
    static benchmark::Timer &RestoreDeltaTimer() {
        static benchmark::Timer timer{};
        return timer;
    }
